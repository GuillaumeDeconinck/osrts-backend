  ...
  describe('testing with REST', () => {
    ...
    describe('while being authenticated', () => {
      ...
      it('should update a runner', (done) => {
        const newRunner = Object.assign({}, runners[0]);
      ...
      describe('on hook checkAndUpdateTag', () => {
        ...
        before((done) => {
          Tags.remove(null)
            ...
            .then(() => Runners.create(defaultRunners))
            .then((res) => {
              runners = res;
              done();
            });
      ...
      describe('on hook checkWave', () => {
        ...
        const correctRunner = {
          name: 'Runner1', team_id: 999, team_name: 'Team 1', type: 'compet', wave_id: 1, date: '15-04-2017', gender: 'M',
        };

        let runner;

        before((done) => {
          Waves.create(defaultWaves)
      ...
      describe('on hook updateDependencies', () => {
        ...
        const defaultWave = {
          num: 1, type: 'compet', date: '15-04-2017', count: 1,
        };
        const correctRunner = {
          name: 'Runner1', team_id: 999, team_name: 'Team 1', type: 'compet', wave_id: 1, date: '15-04-2017', gender: 'M',
        };
    ...
    after((done) => {
      User.remove(null).then(() => Runners.remove(null)).then(() => {
        done();
      });
    });
  });
